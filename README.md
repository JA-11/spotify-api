...
You will need to obtain a Client ID and Client Secret from Spotify in order to utilize their API while running this application. Click [here](https://developer.spotify.com/) to sign up and read the documentation.
